...
git clone https://github.com/BananaDroid-exynos9820/android_vendor_samsung_beyond1lte vendor/samsung/beyond1lte
...
git clone https://github.com/bananadroid/android_hardware_interfaces.git -b 14 hardware/interfaces
