...
git clone https://github.com/TheMuppets/proprietary_vendor_samsung_beyond1lte vendor/samsung/beyond1lte
...
git clone https://github.com/crdroidandroid/android_packages_apps_Nfc.git -b 13.0 packages/apps/Nfc
